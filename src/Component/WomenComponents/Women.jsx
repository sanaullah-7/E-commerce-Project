...
function Women() {
    ...
    // Filter products with category 'women' first
    const MenCategory = all_product.filter((item) => item.category === "women")
    var settings = {
        dots: false,
        arrows: false,
        infinite: true,
                                ...
                                <div className='grid grid-cols-1 sm:grid-cols-2  sm:mt-0 '>
                                    ...
                                    <div className='order-1 sm:order-2'>
                                        <div className='relative z-10'
                                            data-aos="zoom-in"
                                            data-aos-once="true">
                                            <img src={item.img} alt="" className='h-[400px] w-[400px] mt-16 sm:h-[450px] sm:w-[450px] sm:scale-105 lg:scale-150 object-contain mx-auto' />
                                        </div>
                                    </div>
            ...
            <div className=' mx-16 place-items-center mt-20'>
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 place-items-center gap-y-20 md:gap-x-28 lg:gap-x-22'>
                    {MenCategory.map((item) => (
                        <div data-aos="zoom-out" data-aos-delay={item.aosDelay}>
                            <Link to={`/product/${item.id}`}>

                                <div key={item.id} className='sm:w-[15rem] lg:w-[20rem] lg:h-[29rem] bg-gradient-to-r from-primary/40 rounded-lg to-secondary/40  p-4  shadow-2xl shadow-slate-400 dark:shadow-none hover:scale-110 duration-700'>
                                    <div>
