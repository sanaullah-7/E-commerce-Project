...
function NewCollection() {
    return (
        <div className='container'>
            <div>
                <div data-aos="fade-up" className='mt-36 flex flex-col items-center font-sans font-bold   '>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4  gap-x-5  '>
                    ...
                    {new_collections.map((item) => (
                        <div className='bg-white hover:dark:bg-gradient-to-r  text-black shadow-2xl  from-primary to-secondary hover:shadow-2xl hover:shadow-[#584f4f] mx-24 sm:mx-0 p-3 flex flex-col items-center rounded-lg hover:scale-150 mt-10  sm:mt-20 cursor-pointer '
                            data-aos="zoom-in" data-aos-duration="1000">

                            <img data-aos="zoom-in" src={item.image} alt="" className='duration-300 h-[100px%] w-[100%] object-cover rounded-md '></img>
                            <div className=''>
