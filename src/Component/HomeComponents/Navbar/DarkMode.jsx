...
function DarkMode() {
    ...
    //Jab tumne button click kiya (aur theme dark ya light hui), ye effect ek martaba chalega.
    // Ab ye baar baar re-render ke sath nahi chalega — sirf theme ke change hone par chalega.
    useEffect(() => {
        if (theme == "dark") {
